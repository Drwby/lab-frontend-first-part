...
function saveOrganization() {
  EventService.saveOrganization(organization.value)
    .then((response) => {
...
<template>
  <div>
    ...
    <form @submit.prevent="saveOrganization">
      ...
      <label>Email</label>
      <input v-model="organization.email" type="text" placeholder="Email" class="field" />

      <label>Address</label>
      <input v-model="organization.address" type="text" placeholder="Address" class="field" />

      <label> Phone</label>
      <input v-model="organization.phone" type="text" placeholder="Phone" class="field" />

      <button class="button" type="submit">Submit Organization</button>
    </form>
